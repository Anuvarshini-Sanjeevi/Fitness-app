...
class _YogaState extends State<Yoga> {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          backgroundColor: Color.fromARGB(255, 248, 141, 141),
          leading: InkWell(
            onTap: () {
        ...
        child: Row(
          children: [Image.asset('assets/yoga.png'),
            ...
            onTap: () {
             ...
             child: Row(children: [
              Container(
                ...
                width: 43,
                decoration: BoxDecoration(
                  color:widget.isDone? Color.fromARGB(255, 248, 161, 161):Colors.white,
                  shape: BoxShape.circle,border:Border.all(color:Color.fromARGB(255, 248, 141, 141),)
                ),
