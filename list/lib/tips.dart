...
class _TipsState extends State<Tips> {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          backgroundColor: Color.fromARGB(255, 153, 227, 240),
          leading: InkWell(
            onTap: () {
        ...
        children: [
          ...
          SessionCard(Name: 1,isDone: true,),
           SessionCard(Name: 2,isDone: false,),
            ...
            SizedBox(height: 20,),
            Text('Medical Tips',style: GoogleFonts.lato(textStyle:TextStyle(fontSize: 20,fontStyle: FontStyle.italic,fontWeight: FontWeight.bold)),),
            Container(
        ...
        child: Row(
          children: [Image.asset('assets/medical.png'),
            ...
            onTap: () {
             ...
             child: Row(children: [
              Container(
                ...
                width: 43,
                decoration: BoxDecoration(
                  color:widget.isDone? Color.fromARGB(255, 153, 227, 240):Colors.white,
                  shape: BoxShape.circle,border:Border.all(color:Color.fromARGB(255, 153, 227, 240),)
                ),
                child: Icon(Icons.play_arrow,color:widget.isDone? Colors.white:Color.fromARGB(255, 153, 227, 240),),
              ),
              SizedBox(width: 20,),
